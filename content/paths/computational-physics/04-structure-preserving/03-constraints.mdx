...
blurb: 'Constraints are not optional decoration. A rotation that leaves SO(3) is not a slightly wrong rotation — it is a different object.'
order: 1
tier: 'advanced'
minutes: 16
teaches:
...
<Predict
  id="03-constraints-first-prediction"
...
<Recall id="03-constraints-card" concept="constrained-integration">
