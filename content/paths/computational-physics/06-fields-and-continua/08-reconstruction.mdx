...
blurb: 'Piecewise-constant cells are first-order. A limited slope inside the cell buys a second order without new oscillations. The limiter is the whole lesson.'
order: 1
tier: 'advanced'
minutes: 16
teaches:
...
<Predict
  id="08-reconstruction-first-prediction"
...
<Recall id="08-reconstruction-card" concept="reconstruction">
